...
file = URI.open("https://i.ibb.co/wQbV1fh/jack-sparrow.webp")
...
vehicle = Vehicle.new(
  user: user,
	name: 'Flying Boat',
  vehicle_type: 'aerial',
  address: '54 Rue Saint-Louis 75004 Paris',
...
vehicle = Vehicle.new(
  user: user,
	name: 'Hoverboard',
  vehicle_type: 'terrestrial',
  address: '12 Ave Parmentier, 75011 Paris',
  passengers_capacity: 1,
  price_per_day: 15,
  cruising_speed: 10,
...
vehicle = Vehicle.new(
  user: user,
	name: 'Jolly Roger',
  vehicle_type: 'aerial',
  address: '65 rue de vaugirard 75006 paris',
  passengers_capacity: 50,
  price_per_day: 700,
  cruising_speed: 5,
...
vehicle = Vehicle.new(
  user: user,
	name: 'Hippogriff',
  vehicle_type: 'aerial',
  address: '200 rue de vaugirard 75015 paris',
  passengers_capacity: 2,
  price_per_day: 250,
  cruising_speed: 30,
  fuel_type: 'animal',
...
dragon = Vehicle.new(
  ...
  name: 'Dragon',
  vehicle_type: 'aerial',
  address: '250 rue de vaugirard 75015 paris',
...
flying_carpet = Vehicle.new(
  user: user,
	name: 'Flying carpet',
  vehicle_type: 'aerial',
  address: '280 rue de vaugirard 75015 paris',
  passengers_capacity: 3,
  price_per_day: 25,
  cruising_speed: 12,
  fuel_type: 'magical',
...
tardis = Vehicle.new(
  ...
  address: '31 rue de constantinople 75008 paris',
